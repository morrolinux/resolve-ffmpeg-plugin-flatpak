...
flatpak --user remote-add --no-gpg-verify resolve-ffmpeg-repo .repo
flatpak --user install resolve-ffmpeg-repo com.blackmagic.ResolveStudio.ioplugin.ffmpeg_encoder_plugin.dvcp.bundle
```
